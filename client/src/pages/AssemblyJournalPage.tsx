...
export default function AssemblyJournalPage() {
    ...
    const fetchJournals = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${API_URL}/api/journals/assembly`, {
    ...
    const sendToRework = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                `${API_URL}/api/journals/assembly/${id}/rework`,
                {},
                { headers: { Authorization: `Bearer ${token}` } }
            );
        ...
        try {
            ...
            await Promise.all(
                Array.from(selectedIds).map(id =>
                    axios.put(`${API_URL}/api/journals/assembly/${id}`,
                        { isHidden: true },
                        { headers: { Authorization: `Bearer ${token}` } }
                    )
                )
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold">Журнал сборок заказов</h1>
                ...
                <table className="w-full">
                    <thead className="bg-slate-800 text-white">
                        <tr>
                            ...
                            <th className="text-left p-3">Дата сборки</th>
                        ...
                        {loading ? (
                            ...
                            journals.map(j => (
                                ...
                                >
                                    ...
                                    <td className="p-3 font-medium">{formatDate(j.assemblyDate)}</td>
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-[450px] p-6">
                        ...
                        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
                            <p className="text-sm text-gray-700 mb-2">
                                <strong>Журнал сборки #{selectedJournal.id}</strong> от {formatDate(selectedJournal.assemblyDate)}
                            </p>
