...
router.get('/drafts', async (req: Request, res: Response) => {
    try {
        ...
        if (dateFrom || dateTo) {
            where.messageDate = {};
            if (dateFrom) where.messageDate.gte = new Date(dateFrom as string);
            if (dateTo) where.messageDate.lte = new Date(dateTo as string);
        }
 ...
 */
router.get('/drafts/count', async (req: Request, res: Response) => {
    try {
