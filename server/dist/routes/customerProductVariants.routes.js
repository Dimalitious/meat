...
const variants = __importStar(require("../controllers/customerProductVariants.controller"));
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authenticateToken);
router.use(auth_middleware_1.loadUserContext);
const perm = (0, auth_middleware_1.requirePermission)(rbac_constants_1.PERM.CATALOG_CUSTOMERS);
